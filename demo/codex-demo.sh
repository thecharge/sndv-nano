...
sndv init --type greenfield --name codex-demo

echo "[2/7] Scaffold instruction files"
sndv scaffold all
...
echo "[4/7] Open in your Codex tool"
echo "- Use CLAUDE.md / AGENTS.md as instructions"
echo "- Evaluate tasks in .sndv/protocol.qmd"
